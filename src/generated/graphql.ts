...
export type ChangeUserStatusMutation = (
  ...
  & { changeUserStatus?: Maybe<(
    { __typename?: 'ChangeUserStatusPayload' }
    & Pick<ChangeUserStatusPayload, 'clientMutationId'>
    & { status?: Maybe<(
      { __typename?: 'UserStatus' }
      & Pick<UserStatus, 'id' | 'message'>
    )> }
  )> }
);
...
export type ViewerQuery = (
  ...
  & { viewer: (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'name' | 'avatarUrl' | 'createdAt'>
    & { starredRepositories: (
      { __typename?: 'StarredRepositoryConnection' }
...
export const ChangeUserStatusDocument = gql`
  ...
  export class ChangeUserStatusGQL extends Apollo.Mutation<ChangeUserStatusMutation, ChangeUserStatusMutationVariables> {
    document = ChangeUserStatusDocument;
